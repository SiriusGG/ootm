...
public enum DungeonExit {
    ...
    public String toNiceName() {
        ...
        switch (this) {
            ...
            case FIRE_TEMPLE: return names[2];
            case FOREST_TEMPLE: return names[3];
            case GERUDO_TRAINING_GROUND: return names[4];
            case ICE_CAVERN: return names[5];
            case INSIDE_GANONS_CASTLE: return names[6];
            case INSIDE_JABU_JABUS_BELLY: return names[7];
            case INSIDE_THE_DEKU_TREE: return names[8];
            case SHADOW_TEMPLE: return names[9];
            case SPIRIT_TEMPLE: return names[10];
            case WATER_TEMPLE: return names[11];
